...
export const TRIAGE_QUESTIONS: TriageQuestion[] = [
  { id: "stay", question: "Are you trying to understand your right to stay in Poland?" },
  { id: "job", question: "Did your job end, or are you worried about employment documents?" },
  { id: "sick", question: "Are you sick or on medical leave?" },
  { id: "hospital", question: "Were you hospitalized or did you have surgery?" },
  { id: "document", question: "Are you trying to understand a type of official document?" },
  ...
  { id: "urgent", question: "Is your situation urgent or connected to an official deadline?" },
];
...
export function runTriage(answers: TriageAnswers): TriageResult {
  ...
  if (answers.job) {
    add(pathSlugs, "certificate-of-employment", "registering-as-unemployed", "unemployment-benefit");
  ...
  if (pathSlugs.length === 0 && categorySlugs.length === 0) {
    add(categorySlugs, "residence-trc", "work-job-loss", "sickness-sick-leave", "hospitalization-insurance", "official-documents");
  }
