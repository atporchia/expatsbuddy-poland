...
const uk: Dict = {
  ...
  meta: {
    home: {
      title: "Польська бюрократія, зрозуміло для іноземців",
      description:
    ...
    glossary: {
      title: "Глосарій термінів польської бюрократії",
      description:
  ...
  search: {
    ...
    ariaLabel: "Пошук сторінок і термінів глосарія",
    noResults:
